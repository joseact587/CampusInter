    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InscripcionMaterias", x => new { x.InscripcionId, x.MateriaId });
                    table.ForeignKey(
                        name: "FK_InscripcionMaterias_Inscripciones_InscripcionId",
                        column: x => x.InscripcionId,
                        principalTable: "Inscripciones",
                        principalColumn: "InscripcionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InscripcionMaterias_Materias_MateriaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InscripcionMaterias_MateriaId",
